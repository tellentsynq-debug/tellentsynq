    ...
    <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3]">
      ...
      <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between">
        <div className="bg-white/95 backdrop-blur-sm rounded-xl px-4 py-2.5 shadow-lg flex items-center gap-3">
          ...
          <div>
            <div className="text-gray-900 text-xs font-bold leading-none">TellentSynq Workspace</div>
            <div className="text-gray-400 text-[10px] mt-0.5">Global talent, local expertise</div>
          </div>
        </div>
        <div className="bg-red-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
